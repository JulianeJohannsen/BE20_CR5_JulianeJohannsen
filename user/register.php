...
if (isset($_POST["register"])) {
    ...
    if ($error === false) {
        ...
        $sql = "INSERT INTO `user`(`first_name`, `last_name`, `email`, `pass`, `phone`,`zip`, `city`, `street`, `picture`) VALUES ('$first_name', '$last_name', '$email', '$pass', '$phone', '$zip', '$city', '$street', '$picture[0]')";
        $result = mysqli_query($connect, $sql);
...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <p>Animals are living beings. For their safety we need all contact details below.</p>
